...
\end{center}
\underline{Linguaggi di programmazione}: Python, SQL, C.\\
\underline{OS}: Windows, Linux (Debian, Void, Slackware, LFS).\\
\underline{Altro}: Git, MS Office, \LaTeX, TiKz, UML, BPM, Emacs, Notion.\\
...
\textbf{Como Luxury Suites} Como, Italia (2 anni 9 mesi).\\
...
\begin{itemize}
	...
	\item[--] Sviluppo della architettura concettuale del sistema di ricerca per il portale del dipartimento.
...
\begin{itemize}
	\item[--] Sviluppo della proposta di trasferimento dell'infrastruttura dipartimentale a Software Open source
	.
